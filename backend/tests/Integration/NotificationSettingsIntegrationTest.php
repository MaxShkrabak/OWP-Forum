...
final class NotificationSettingsIntegrationTest extends TestCase
{
    ...
    public function testGetAndUpdateNotificationSettings(): void
    {
        ...
        $stmt = $this->pdo->prepare("SELECT emailNotificationsEnabled FROM dbo.Forum_Users WHERE UserID = :id");
    ...
    private function createSessionForUser(int $userId): string
    {
        ...
        $stmt = $this->pdo->prepare("INSERT INTO dbo.Forum_Sessions (UserID, TokenHash, ExpiresAt) VALUES (:userId, :hash, DATEADD(HOUR, 24, SYSUTCDATETIME()))");
