    ...
    <div class="page">
        <div class="page-container d-flex">
            <div class="panel-nav w-25">
                ...
                <div class="nav-opts" v-for="tab in tabs">
            ...
            <!-- Admin Panel Content -->
            <div class="panel-content w-75 text-center pt-5">

                <div class="tab-content" v-for="tab in tabs">
                    <div v-show="activeTab === tab.name">
                        <!-- 
                    We will do a general Admin COMPONENT in which we will pass in
                     the name as a prop, and it will build the component based on it 
                     <AdminPanelComponent :tab="tab.name" />
                -->
                        {{ tab.name }}
                    </div>
                </div>
